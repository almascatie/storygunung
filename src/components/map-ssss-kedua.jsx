...
export function MapExperience({ mode }) {
  ...
  /*
   * Prop mode hanya digunakan sebagai
   * nilai awal / perubahan dari parent.
   *
   * Setelah tombol internal diklik,
   * modeLokal tetap bisa mengontrol tampilan.
   */
  useEffect(() => {
  ...
  const masukMitigasi = () => {
    ...
    /*
     * Hentikan animasi / transisi kamera
     * yang sedang berjalan.
     */
    map.stop()

    /*
     * Kamera bergerak menuju Mitigasi.
     */
    map.flyTo({
  ...
  const kembaliHome = () => {
    ...
    /*
     * Kamera bergerak kembali ke Home.
     */
    map.flyTo({
    ...
    /*
     * Setelah flyTo selesai,
     * putaran 360 dimulai kembali.
     */
    map.once('moveend', () => {
      if (
        map &&
